...
// //   acc[RekeningGroep.naam] = RekeningGroep.rekeningen.reduce((acc, budget) => acc + budget.bedrag, 0)
...
// //     acc[RekeningGroep.naam] = RekeningGroep.rekeningen.reduce((acc, budget) => acc + (budget.budgetOpPeilDatum ?? 0), 0)
