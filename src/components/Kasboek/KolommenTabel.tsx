...
//                   </Box>
//                   &nbsp;
//                   <Typography sx={{ fontSize: '15px' }} component="span">{RekeningGroep.naam}: {currencyFormatter.format(berekenRekeningTotaal(RekeningGroep))} {RekeningGroep.rekeningen.length > 0 && `(van ${currencyFormatter.format(budgetOpPeilDatum(RekeningGroep.naam))})`}</Typography>
//                 </Box>
//               </AccordionSummary>
