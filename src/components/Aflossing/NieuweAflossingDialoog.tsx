...
// import { transformRekeningGroepenToBetalingsSoorten } from '../Header/HeaderExports.ts';
...
//     id: 0,
//     naam: "",
//     RekeningGroepSoort: RekeningGroepSoort.aflossing,
//     nummer: "",
//     bankNaam: undefined,
//     rekeningIcoonNaam: undefined,
//     sortOrder: 0,
...
//   const [RekeningGroep, setRekening] = useState<RekeningGroepDTO>(initialRekening);
...
//   };
//   const handleInputRekeningWijziging = <K extends keyof RekeningGroepDTO>(key: K, value: RekeningGroepDTO[K]) => {
//     setRekening({ ...RekeningGroep, [key]: value })
//   };
